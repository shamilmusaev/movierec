...
export function MovieCard({
  ...
  return (
    <motion.div
      key={movie.id}
      className="w-full lg:max-w-md lg:mx-auto h-[85vh] rounded-xl overflow-hidden bg-zinc-900 shadow-2xl relative"
      drag="x"
    ...
    >
      ...
      <div className="absolute bottom-0 left-0 right-0 p-6 pb-safe text-white">
        <h2 className="text-4xl font-bold mb-2 line-clamp-2 drop-shadow-lg">{movie.title}</h2>
        <p className="text-base text-white/90 line-clamp-2 mb-3 drop-shadow-md">{movie.overview}</p>
        
        <div className="flex items-center gap-4 text-base drop-shadow-md">
