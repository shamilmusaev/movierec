...
- [x] 1.2 Test desktop layout on 1920x1080, 2560x1440 screens
- [x] 1.3 Verify mobile remains full-screen
- [x] 1.4 Add `loop=1&playlist={videoKey}` to YouTube embed URL
- [x] 1.5 Test video looping behavior
- [x] 1.6 Filter movies without trailers in `loadMovies()`
- [x] 1.7 Add validation: `m.trailer?.key` must exist
- [x] 1.8 Test with filtered movie list
